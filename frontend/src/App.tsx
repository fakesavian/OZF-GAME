...
import FPVMazeScreen from "./screens/FPVMazeScreen"; // Added import
import StoryModeScreen from "./screens/StoryMode"; // Added StoryModeScreen import
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/fpv-maze" element={<FPVMazeScreen />} /> {/* Added route */}
      <Route path="/story" element={<StoryModeScreen />} /> {/* Added Story Mode route */}
