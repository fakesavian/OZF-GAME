...
`}
      ...
      <button
        ...
        className="border border-green-400 px-6 py-2 hover:bg-green-900 transition-all w-64 text-left crt-button" // Added crt-button as per instruction, though it might not have a style yet
      >
        ▶ Story Mode
      </button>
